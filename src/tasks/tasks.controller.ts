...
//   }
  ...
  @Patch('/:id')
  public updateTask(@Param() params: FindOneParams, @Body() updateTaskDto: CreateTaskDto): ITask | undefined {
      const task = this.findOneOrFail(params.id);

      const updatedTask = this.tasksService.updateTask(task, updateTaskDto);
      return updatedTask;
  }
